...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'gf-tost':
				// GIRLFRIEND CODE
				tex = Paths.getSparrowAtlas('GF_tost_assets','shared',true);
				frames = tex;
				//animation.addByPrefix('cheer', 'GF Cheer', 24, false);
				//animation.addByPrefix('singLEFT', 'GF left note', 24, false);
				//animation.addByPrefix('singRIGHT', 'GF Right Note', 24, false);
			...
			case 'tost':
				tex = Paths.getSparrowAtlas('tost','shared',true);
				frames = tex;
				...
				addOffset('idle');
				addOffset("singUP", -2, 119);
				addOffset("singRIGHT", -11, -26);
				addOffset("singLEFT", 22, -28);
				addOffset("singDOWN", -16, -27);
	...
	public function dance(forced:Bool = false, altAnim:Bool = false)
	{
		if (!debugMode)
		{
			switch (curCharacter)
			{
				case 'gf' | 'gf-christmas' | 'gf-car' | 'gf-pixel' | 'gf-tost':
